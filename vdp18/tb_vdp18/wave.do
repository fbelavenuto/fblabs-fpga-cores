...
add wave -noupdate /tb/vram_ce_n_s
...
add wave -noupdate -radix unsigned /tb/u_target/cpu_io_b/mode_i
...
WaveRestoreCursors {{Cursor 1} {2572113 ns} 0}
...
update
WaveRestoreZoom {2897 ns} {5141329 ns}
